...
flag = 0;
if flag == 0
    load('non_modNet_initial_data.mat');
    %load('modNet_initial_data_connec_conP090.mat');
...
ylabel('Neuron index');
tick = 0:50:250;
labelName = {'0','50','100','150','200','250'};
set(gca,'xtick',tick,'xticklabel',labelName);
...
colorbar('linewidth',1.2,'FontSize',16,...
    'Ticks',[0.48,0.485,0.49,0.495,0.5,0.505,0.51,0.515,0.52]);
for i = 1:modNum
    for j = 1:modNum
