...
xtick = 0:simTime*10:iterNum*simTime;
xlabelName = {'0','10','20','30','40','50','60'};
...
if exist('modNet_avgFre.mat','file') ~= 0 
    load('modNet_avgFre.mat');
else
    modNet_avgFre = [];
end;
modNet_avgFre = [modNet_avgFre;temp];
save('modNet_avgFre.mat','modNet_avgFre');
modNet_avgFre
